      ...
      weeks: [
        {
          ...
          focus: 'HTTP lifecycle, DNS, TLS, Linux debugging',
          moduleIds: ['networking', 'linux', 'git'],
        },
        {
          week: 14,
          title: 'Docker & CI/CD',
          focus: 'Dockerfiles, compose, pipelines, deployment strategies',
          moduleIds: ['docker', 'cicd'],
        },
        {
          week: 15,
          title: 'Kubernetes & Cloud',
          focus: 'Pods, services, ingress, AWS/GCP patterns',
          moduleIds: ['kubernetes', 'cloud'],
        },
        {
          week: 16,
          title: 'Quality, Security & Observability',
          focus: 'Testing pyramid, OWASP, logs/metrics/traces',
          moduleIds: ['testing', 'security', 'observability', 'performance'],
        },
      ],
    },
    {
